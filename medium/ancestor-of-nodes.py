...
def ancestors_of_node(n:int,edges:List[List[int]]):
        ...
        def dfs(node, ancestors, visited):
            ...
            for parent in graph[node]:
                ancestors[node].update(dfs(parent, ancestors, visited))
